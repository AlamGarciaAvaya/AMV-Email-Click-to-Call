$(document).ready(function() {
  $('#gencode-btn').on('click', function() {
    ...
    if ($('#mensaje-txt').val() == '') {
      var mensaje = $('#mensaje-txt').attr('placeholder');
    } else {
